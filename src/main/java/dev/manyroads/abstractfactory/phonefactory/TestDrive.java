package dev.manyroads.abstractfactory.phonefactory;
...
class Iphone extends Phone {
    Iphone(PhoneDetailsFactory detailsFactory) {
        camera = new IphoneCamera();
        display = new IphoneDisplay();
        processor = new IphoneProcessor();
        security = new IphoneSecurity();
    }
...
class Samsung extends Phone {
    Samsung(PhoneDetailsFactory detailsFactory) {
        ...
        processor = new SamsungProcessor();
        security = new SamsungSecurity();
    }
